...
export default function SpinWheel() {
  ...
  return (
    <>
      <Component className="fixed w-screen h-dvh bg-black/80 flex items-center justify-center z-10 ">
        <div
          style={{ background: "linear-gradient(90deg, #00B8FF 0%, #0459EC 100%)" }}
          className=" rounded-3xl bg-red w-full max-w-3xl h-max py-16    fixed z-10 inset-0 m-auto"
        >
