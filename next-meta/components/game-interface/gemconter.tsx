...
const GemProgressBar = () => {
  ...
  return (
    <div className="fixed top-8 right-0 left-0 mx-auto border-teal border rounded-full  w-[250px] items-center space-x-2 bg-teal-fg bg-opacity-70 p-2  shadow-md">
